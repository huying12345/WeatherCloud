...
namespace Yamon.Module.Typhoon.Web.Controllers
{
    ...
    public partial class _TyphoonNameController :BaseController
    {
        ...
        {
            TyphoonName model = dal.GetCreateFormDefaultValue();
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new TyphoonNameDAL();
            ...
            string formPath = string.Format("~/Areas/Typhoon/Views/TyphoonName/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonName/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonName/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    TyphoonName model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonName/_/Show.cshtml");
    return View(formPath,model);
}
