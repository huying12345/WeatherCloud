...
namespace Yamon.Module.Typhoon.Web.Controllers
{
    ...
    public partial class _TyphoonInfoController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new TyphoonInfoDAL();
            ...
            string formPath = string.Format("~/Areas/Typhoon/Views/TyphoonInfo/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    TyphoonInfo model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonInfo/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonInfo/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    TyphoonInfo model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Typhoon/Views/TyphoonInfo/_/Show.cshtml");
    return View(formPath,model);
}
