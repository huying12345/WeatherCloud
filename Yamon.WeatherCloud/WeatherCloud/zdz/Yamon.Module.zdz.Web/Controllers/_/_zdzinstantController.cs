...
namespace Yamon.Module.zdz.Web.Controllers
{
    ...
    public partial class _zdzinstantController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/zdz/Views/zdzinstant/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    zdzinstant model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzinstant/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzinstant/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    zdzinstant model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzinstant/_/Show.cshtml");
    return View(formPath,model);
}
