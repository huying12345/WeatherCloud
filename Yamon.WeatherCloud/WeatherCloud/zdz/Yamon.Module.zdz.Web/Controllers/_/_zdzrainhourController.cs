...
namespace Yamon.Module.zdz.Web.Controllers
{
    ...
    public partial class _zdzrainhourController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new zdzrainhourDAL();
            ...
            string formPath = string.Format("~/Areas/zdz/Views/zdzrainhour/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    zdzrainhour model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhour/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhour/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    zdzrainhour model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhour/_/Show.cshtml");
    return View(formPath,model);
}
