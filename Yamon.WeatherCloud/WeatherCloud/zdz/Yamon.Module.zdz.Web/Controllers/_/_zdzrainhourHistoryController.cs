...
namespace Yamon.Module.zdz.Web.Controllers
{
    ...
    public partial class _zdzrainhourHistoryController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new zdzrainhourHistoryDAL();
            ...
            string formPath = string.Format("~/Areas/zdz/Views/zdzrainhourHistory/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    zdzrainhourHistory model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhourHistory/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhourHistory/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    zdzrainhourHistory model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/zdz/Views/zdzrainhourHistory/_/Show.cshtml");
    return View(formPath,model);
}
