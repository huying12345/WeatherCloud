...
namespace Yamon.Module.Weather.Web.Controllers
{
    ...
    public partial class _WeatherTextController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new WeatherTextDAL();
            ...
            string formPath = string.Format("~/Areas/Weather/Views/WeatherText/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    WeatherText model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherText/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherText/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    WeatherText model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherText/_/Show.cshtml");
    return View(formPath,model);
}
