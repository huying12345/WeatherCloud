...
namespace Yamon.Module.Weather.Web.Controllers
{
    ...
    public partial class _WeatherImgController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/Weather/Views/WeatherImg/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    WeatherImg model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherImg/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherImg/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    WeatherImg model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherImg/_/Show.cshtml");
    return View(formPath,model);
}
