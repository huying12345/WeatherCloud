...
namespace Yamon.Module.Weather.Web.Controllers
{
    ...
    public partial class _WeatherNodesController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new WeatherNodesDAL();
            ...
            string formPath = string.Format("~/Areas/Weather/Views/WeatherNodes/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    WeatherNodes model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodes/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodes/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    WeatherNodes model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodes/_/Show.cshtml");
    return View(formPath,model);
}
