...
namespace Yamon.Module.Weather.Web.Controllers
{
    ...
    public partial class _WeatherNodesSubscribeController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new WeatherNodesSubscribeDAL();
            ...
            string formPath = string.Format("~/Areas/Weather/Views/WeatherNodesSubscribe/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    WeatherNodesSubscribe model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodesSubscribe/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodesSubscribe/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    WeatherNodesSubscribe model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Weather/Views/WeatherNodesSubscribe/_/Show.cshtml");
    return View(formPath,model);
}
