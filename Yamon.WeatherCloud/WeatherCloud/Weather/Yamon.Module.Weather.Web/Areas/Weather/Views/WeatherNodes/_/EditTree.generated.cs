...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/Weather/Views/WeatherNodes/_/EditTree.cshtml")]
    public partial class _Areas_Weather_Views_WeatherNodes___EditTree_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_Weather_Views_WeatherNodes___EditTree_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 2 "..\..\Areas\Weather\Views\WeatherNodes\_\EditTree.cshtml"
...
"             }\r\n                });\r\n            },\r\n            onDrop: functio" +
"n (target, source, point) {\r\n\r\n                var targetId = jQuery(\'#tt\').tree" +
"(\'getNode\', target).id;\r\n\r\n                jQuery.ajax({\r\n                    ur" +
"l: _apiUrl + \'/SaveEditTree\',\r\n                    type: \'post\',\r\n              " +
"      dataType: \'json\',\r\n                    data: {\r\n                        id" +
": source.id,\r\n                        targetId: targetId,\r\n                     " +
"   point: point\r\n                    },\r\n                    success: function (" +
"data) {\r\n                        if (data.success) {\r\n                          " +
